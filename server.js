...
app.post("/generate-pdf/devis", async (req, res) => {
  ...
  try {
    ...
    const pdfbuffer = await page.pdf({
      ...
      headerTemplate: `<div style=" font-family: 'Inter', sans-serif; style="display:flex; width:100%; margin:1cm  0cm 0cm 0cm; padding:0 1cm; display:flex; justify-content:space-between;">
...
app.post("/generate-pdf/facture", async (req, res) => {
  ...
  const htmlPage = html
    ...
    .replace("{{Type}}", String(data.type).toUpperCase())
